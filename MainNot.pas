...
//****************************************
       ...
       login.free;
//проверка наличия настройки почтовой базы
// обновление настройки почтовой базы
// делается каждый раз на случай если логинятся разные люди
 ...
 // begin
      ...
      mResults.Free;
//  end;
//проверка наличия настройки базы
  ...
  FileIni.Free;
  CheckNewDocFromAllDb(false); //первичная проверка баз данных на наличие новых писем сразу после запуска
end;
